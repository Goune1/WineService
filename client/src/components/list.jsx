...
export default function Example() {
  ...
  return (
    <div>
      ...
      <div className='flex flex-col items-center justify-center pt-12 z-50'>
        ...
        <>
          ...
          <form onSubmit={AddhandleSubmit}>
            <div className='flex z-100 flex-col pb-14 mt-4 items-center justify-center border border-gray-300 rounded-lg w-64 lg:w-96 bg-white'>
      ...
      <ul role="list" className="grid grid-cols-1  gap-x-4 gap-y-6 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 xl:gap-x-8 pt-12 pb-44 ml-8 md:ml-10 lg:ml-24 z-0">
