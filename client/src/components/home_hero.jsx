  ...
  return (
    ...
    <nav className="flex items-center justify-between p-5 lg:px-8" aria-label="Global">
        ...
        <div className="flex lg:hidden">
          {isLoggedIn ? (
            <span className='pr-2'>Bonjour, {username} !</span>
          ) : (
            null
          )}
        ...
        <div className="py-24 sm:py-32 lg:pb-40">
          <div className="mx-auto max-w-7xl px-6 lg:px-8">
            <div className="mx-auto max-w-2xl text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-7xl">Le <span className='text-indigo-600'>meilleur</span> moyen de gérer votre Cave</h1>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Découvrez WineService, grâce à sa gestion intelligente de votre cave, vous pourrez rapidement savoir où vous en êtes 
              </p>
